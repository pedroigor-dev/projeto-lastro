...
import dev.pedrocosta.vertex.application.SpecNotFoundException;
import dev.pedrocosta.vertex.domain.DomainException;
import dev.pedrocosta.vertex.domain.InvalidTransitionException;
...
public class ApiExceptionHandler {
    ...
    private ProblemDetail problem(
        ...
        problem.setType(URI.create("https://github.com/pedroigor-dev/vertex-sdd-hub/problems/" + type));
        return problem;
    }
}
